CREATE TABLE IF NOT EXISTS employee(id INTEGER, name VARCHAR(255), department VARCHAR(255), salary INTEGER);


INSERT INTO employee VALUES (1, 'Boigie Ronan', 'Marketing', 569687),
(2, 'Russell Heimes', 'Product Management', 847396),
(3, 'Ezra OKynsillaghe', 'Human Resources', 354226),
...
(165, 'Nellie ONoulane', 'Services', 196115),
...
(176, 'Kirstin OSharkey', 'Sales', 369010),
...
(469, 'Anselm OHagirtie', 'Services', 209077),
...
(474, 'Aurie ODooley', 'Marketing', 651770),
...
(506, 'Kenon ODonohoe', 'Sales', 834277),
...
(535, 'Averell OCrotty', 'Services', 92295),
...
(724, 'Emmye ODonnell', 'Support', 310091),
...
(805, 'Zane OHagirtie', 'Marketing', 95052),
